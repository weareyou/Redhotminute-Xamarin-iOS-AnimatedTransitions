...
{
    public class StartFrameTransitioningDelegate<T> : BaseTransitioningDelegate<T> where T : BaseTransition
    {
        public StartFrameTransitioningDelegate(T transition) : base(transition)
        {
        }
